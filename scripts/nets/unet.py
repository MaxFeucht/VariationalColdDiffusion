...
class Unet(nn.Module):
    """
    With slight modifications taken from Risannen et al., (2022): Generative Modeling with inverse Heat Dissipation. https://arxiv.org/abs/2206.13397
    ...
    def __init__(
        ...
        #time_embed_dim = time_embed_dim * 2 # Double the time embedding dimension for noise concat
    ...
    def forward(self, xt, timesteps, y=None, t2=None):
        """
        ...
        # emb_noise = th.randn_like(emb) * 0.01
        # emb = th.cat([emb, emb_noise], dim=1)
        ...
        for i, module in enumerate(self.input_blocks):
            ...
            #if i > 0:
                # h_noise = th.randn_like(h) * 0.01
                # h = th.cat([h, h_noise], dim=1)
                # h = h * th.randn_like(h) * 0.01
