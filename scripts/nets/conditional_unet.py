...
class AutoEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.last_dense = nn.Linear(input_block_chans[-1]*curr_res*curr_res, latent_dim)
...
class AEUnet(nn.Module):
    ...
    def __init__(
        ...
        # VAE Encoder
        self.autoencoder = AutoEncoder(image_size, 
                                      in_channels, 
    ...
    def forward(self, xt, t, cond=None, prior=None, t2 = None, y=None):
        ...
        z_sem = self.autoencoder(xt, cond, emb, y)
        ...
        if self.vae_loc == 'emb':
            emb = self.vae_injection(emb, z_sem)
        ...
        h = h.type(xt.dtype)
        return self.out(h), None # None to mimick KL div
